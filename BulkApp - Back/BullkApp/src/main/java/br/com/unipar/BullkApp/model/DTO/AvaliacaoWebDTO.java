...
public class AvaliacaoWebDTO {
    ...
    public static AvaliacaoWebDTO consultaDTO(Avaliacao avaliacao) throws DataFormatException, IOException {
        AvaliacaoWebDTO avaliacaoDTO = new AvaliacaoWebDTO();
